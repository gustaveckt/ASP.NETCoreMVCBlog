...
namespace Blog.Controllers.Admin
{
    ...
    public class TagsController : Controller
    {
        ...
        {
            return View("~/Views/Admin/Tags/Index.cshtml", await _context.Tags.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create(TagCreateDto tagDto)
        {
            if (ModelState.IsValid)
            {
                ...
                tag.Slug = Helpers.Slug(tag.Name);
                _context.Add(tag);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            return View("~/Views/Admin/Tags/Create.cshtml", tagDto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, TagUpdateDto tagDto)
        {
            if (id != tagDto.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var tag = _mapper.Map<Tag>(tagDto);
                    var slug = Helpers.Slug(tag.Name);
                    if (tagDto.Slug == slug)
                    {
                        tag.Slug = slug;
                    }
            ...
            return View("~/Views/Admin/Tags/Edit.cshtml", tagDto);
        }
