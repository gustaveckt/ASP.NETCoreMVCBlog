    ...
    public partial class ExtendIdentityUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_PostTags_ToPosts",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostTags_ToTags",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Categori__737584F6E9B4E378",
                table: "Categories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Categori__BC7B5FB6EFE49953",
                table: "Categories",
                column: "Slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__tmp_ms_x__BC7B5FB65A944A0B",
                table: "Posts",
                column: "Slug",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Tags__737584F6D76DF2E9",
                table: "Tags",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Tags__BC7B5FB6BAD69644",
                table: "Tags",
                column: "Slug",
                unique: true);
        }
